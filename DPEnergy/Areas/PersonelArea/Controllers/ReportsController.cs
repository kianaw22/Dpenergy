...
namespace DPEnergy.Areas.PersonelArea
{
    ...
    public class ReportsController : Controller
    {
        ...
        public IActionResult UploadReports(IEnumerable<IFormFile> filearray, string path)
        {
            ...
            var filename = _upload.UploadReport(filearray, path, "");
            if (filename == "-1")
            {
        ...
        {
            var model = _context.ReportsUW.Get(x => x.Area == "PersonelArea");
            return View(model);
        }
